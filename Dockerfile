...
ARG URL_PAYMENTS="http://a50691d0431c04a0bb79150dc0b8604a-699217277.us-east-1.elb.amazonaws.com:8083"
ARG URL_SHIPPING="http://a21343f0988a849698738dc708d0367d-919086047.us-east-1.elb.amazonaws.com:8085"
ARG URL_PRODUCTS="http://a7cbbc7eee2d048b08f2f78aff89481f-302219217.us-east-1.elb.amazonaws.com:8080"
ENV URL_PAYMENTS=$URL_PAYMENTS
ENV URL_SHIPPING=$URL_SHIPPING
ENV URL_PRODUCTS=$URL_PRODUCTS
RUN echo "Starting application with parameters:"
RUN echo "URL_PAYMENTS=$URL_PAYMENTS"
RUN echo "URL_SHIPPING=$URL_SHIPPING"
RUN echo "URL_PRODUCTS=$URL_PRODUCTS"
EXPOSE 8081
